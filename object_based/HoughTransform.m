...
% single call.
[circen_1, cirrad_1] = imfindcircles(pixelCandidates, [15, 40], 'Sensitivity', 0.8, 'EdgeThreshold', 0.25);
[circen_2, cirrad_2] = imfindcircles(pixelCandidates, [40, 120], 'Sensitivity', 0.8, 'EdgeThreshold', 0.25);
